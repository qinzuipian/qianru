<template>
    <div class="content">
				...
				<div class="botMain">
						<p> <span class="el-icon-school"></span><span class="fzstyle">住院预结算</span></p>
								<el-row>
									<!-- <el-col :span="8">
						...
						<!-- 		<el-row>
							...
							<el-row>
								<el-col :span="24">
									<div class="grid-content">
										 <el-button type="success" @click="gitHosave">住院预结算保存</el-button>
									</div>
								</el-col>
							</el-row>
  ...
  methods: {
    ...
    gitHospitlaMsg() {
      ...
      axios({
        ...
        url:
          axios.PARK_API +
          "/medical_reimbursement/hospitalizationregister/queryinfo",
        params: {
        ...
        if (res.data.code == 0) {
          var hosdata = res.data.dataInfo;
          // this.AAB034 = '商洛市';
          hosdata.AAB034 == undefined? (this.AAB034 = ""):(this.AAB034 = hosdata.AAB034);
          hosdata.AKC190 == undefined? (this.AKC190 = ""):(this.AKC190 = hosdata.AKC190);
          hosdata.AAE140 == undefined? (this.AAE140 = ""):(this.AAE140 = hosdata.AAE140);
          hosdata.BKC023 == undefined? (this.BKC023 = ""):(this.BKC023 = hosdata.BKC023);
          hosdata.AKC194 == undefined? (this.AKC194 = ""):(this.AKC194 = hosdata.AKC194);
          hosdata.HISZJE == undefined? (this.HISZJE = localStorage.getItem("hiszje")):(this.HISZJE = localStorage.getItem("hiszje"));
          /* if( hosdata.AAB034 == undefined ||  hosdata.AKC190 == undefined || hosdata.AAE140 == undefined
					|| hosdata.BKC023 == undefined || hosdata.AKC194 == undefined || hosdata.HISZJE == undefined) {
						this.AAB034 = "";
						this.AKC190 = "";
						this.AAE140 = "";
						this.BKC023 = "";
						...
						this.BKC023 = hosdata.BKC023
						this.AKC194 = hosdata.AKC194
      ...
      axios({
        ...
        if (res.data.code == 0) {
          ...
          axios({
            ...
            if (res.data.code == 0) {
              //修改
              this.hospitalUpload(this.hospitalxml);
