      ...
      axios({
        ...
        .then(res => {
          if (res.data.code == 0) {
				...
				/* if(this.BKC331 == undefined || this.BKC332 == undefined || this.BKC333 == undefined || this.BKC334 == undefined
					|| this.BKC335 == undefined || this.BKC336 == undefined || this.BKC337 == undefined || this.AKC204 == undefined
					|| this.AKC206 == undefined || this.AKC209 == undefined || this.AKC207 == undefined || this.AKC216 == undefined
					|| this.AKC217 == undefined || this.HISZJE == undefined || this.AKC255 == undefined) {
						this.BKC331 = "";
						this.BKC332 = "";
						this.BKC333 = "";
						this.BKC334 = "";
...
+"</transferinfo>"; */
				...
				// 将下载下来的数据保存到数据库
						axios({
							method: "post",
							url: axios.PARK_API + "/medical_reimbursement/settlementcostinfo/updateSettlementCost",
							data: {
										xml : wordsContent
							},
							headers: {
