    ...
    <div class="screen">
        ...
        <transition name="el-zoom-in-center" class="transitionScreen">
            <div v-show="screenOpen" class="transition-box">
                ...
                <div v-show="cliType">
                      <p>门诊类别</p>
                      <el-select size="mini" v-model="clinicType" @change="search" placeholder="请选择" class="leixingSelect">
                          <el-option
                                  v-for="item in clinicTypeOptions"
                                  :key="item.value"
                                  :label="item.label"
                                  :value="item.value">
                          </el-option>
                ...
                <div v-show="jqcliType">
                    <p>门诊类别</p>
                    <el-select size="mini" v-model="clinicType" @change="jqsearch" placeholder="请选择" class="leixingSelect">
                        <el-option
                                v-for="item in clinicTypeOptions"
                                :key="item.value"
                                :label="item.label"
...
export default {
  ...
  methods: {
    ...
    search() {
      if (this.dataWay == 2 && this.person == 1) {
        ...
        this.serchData.pageSize = 10;
        this.serchData.type = this.examineText;
        this.serchData.reimbTypeCode = this.clinicType;
    ...
    clear() {
      ...
      this.serchData.insuNo = "";
      this.serchData.name = "";
      this.serchData.sysFlag = "";
      this.serchData.pageSize = 10;
      this.serchData.type = "";
      this.serchData.reimbTypeCode = "";
      this.$emit("clear", this.serchData);
    },
    /*  clearAll() {
    ...
    examineFocus() {
      ...
      axios({
        method: "post",
        url: axios.PARK_API + "/outpatient/biz/rstdatpresmsg/listMsgType",
        params: {
          // type: this.examineText
          type: ""
        }
