...
export default {
  ...
  methods: {
    ...
    clear() {
      /* this.serchData.leixingText = "";
      this.serchData.hospitalId = "";
      this.serchData.jishen = "";
      this.serchData.personText = "";
      this.serchData.examineText = "";
      this.serchData.inDateTime = "";
      this.serchData.inDateEnd = ""; */
      this.leixingText = "";
      this.hospitalId = "";
      this.jishen = "";
      this.personText = "";
